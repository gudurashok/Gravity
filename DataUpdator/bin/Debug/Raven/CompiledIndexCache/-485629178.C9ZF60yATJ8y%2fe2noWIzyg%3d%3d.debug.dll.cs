...
public class Index_Auto_2fPartyEntities_2fByAddresses_Address_AreaAndAddresses_Address_City : Raven.Database.Linq.AbstractViewGenerator
{
	public Index_Auto_2fPartyEntities_2fByAddresses_Address_AreaAndAddresses_Address_City()
	{
		this.ViewText = @"from doc in docs.PartyEntities
from docAddressesItem in ((IEnumerable<dynamic>)doc.Addresses).DefaultIfEmpty()
select new { Addresses_Address_City = docAddressesItem.Address.City, Addresses_Address_Area = docAddressesItem.Address.Area }";
