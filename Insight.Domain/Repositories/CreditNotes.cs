...
{
    public class CreditNotes : Transactions
    {
        public CreditNotes(VoucherSearchCriteria voucherSearchCriteria)
        ...
        {
            IQueryable<TransactionHeaderEntity> query = s.Query<CreditNoteEntity>();
