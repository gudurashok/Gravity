...
namespace Insight.Domain.Entities
{
    public class JournalVoucherEntity : TransactionHeaderEntity
    {
        ...
        [Required(ErrorMessageResourceType = typeof(Resources), ErrorMessageResourceName = "AccountToCreditCannotBeEmpty")]
        public string CreditAccountId { get; set; }
        public string NotesCredit { get; set; }
        [Required(ErrorMessageResourceType = typeof(Resources), ErrorMessageResourceName = "AccountToDebitCannotBeEmpty")]
